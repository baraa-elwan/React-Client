...
import { edit } from '../../../shared/actions/usersActions'
//redux
...
class Form extends Component {
    ...
    onSubmit(values) {
        ...
        this.props.edit(this.props.initialValues.id, {...values, rids:this.state.selectedRoles})
        this.props.close()
    }
    ...
    render() {
        return (
            <div className='m-user-details'>
                ...
                <form method='PUT' className='form m-form ' onSubmit={this.props.handleSubmit((event) => this.onSubmit(event))}>
                    ...
                    <button type='submit' className='btn btn-sm  btn-dark btn-secondary'
                        onClick={()=>this.props.close()}>save</button>
...
let mapDispatchToProps = (dispatch) => {
    return bindActionCreators({ edit, loadRoles }, dispatch)
}
